...
<body>
 ...
 <!---Header Section End-->  
<!---About Section Start-->
 <section class="about" id="about" style="margin-top:120px;">
    <div class="image" data-aos="zoom-in-right">
        <img id="detailedimg" src="assets/img/customer/product-1.png">
    </div>
    <div class="content" data-aos="zoom-in-left">
        <h3 class="title" style="text-align: center;">Humberger</h3>
        <p style="text-align: center;">
            BBQ Pork Burger (single) <br>
            Price - 6500 MMK
        </p>
        <div class="icons">
          <img class="viewmenu" src="assets/img/customer/product-2.png">
          <img class="viewmenu" src="assets/img/customer/product-3.png">
          <img class="viewmenu" src="assets/img/customer/product-4.png">
          <img class="viewmenu" src="assets/img/customer/product-5.png">
        </div>
...
<!---About Section End-->
 <!---Menu Section Start-->
 <section class="menu" id="menu" style="margin-top:20px;">
